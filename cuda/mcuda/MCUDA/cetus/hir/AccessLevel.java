...
public final class AccessLevel extends Declaration
{
   ...
   *
   * @param alevel The access level to print.
   * @param stream The stream on which to print the access level.
   */
  public static void defaultPrint(AccessLevel alevel, OutputStream stream)
  {
    PrintStream p = new PrintStream(stream);
    alevel.spec.print(stream);
    p.println(":");
  }
