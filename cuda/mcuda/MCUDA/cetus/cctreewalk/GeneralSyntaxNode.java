...
//this is the tree node in the syntax tree

import java.lang.*;
import java.util.*;

public class  GeneralSyntaxNode extends GeneralTreeNode implements CCTypeEnum
{
...
//----------------------------for debugging purposes-----------------------------//
	public String toString()
	{
		...
		*/
		...
		else if (typename_hash.getEnumValue(info) == __ambiguity__)
		{
			str = "Ambiguity: " + info + "\n";
		}
		else
