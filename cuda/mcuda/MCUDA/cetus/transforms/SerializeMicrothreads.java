 ...
 */
public class SerializeMicrothreads extends KernelTransformPass
{
  private static int labelNum;
  
  public String getPassName()
  {
    return new String("[SerializeMicrothreads-MCUDA]");
  }

  public SerializeMicrothreads(Program program)
  {
    super(program);
    labelNum = 1;
  }
